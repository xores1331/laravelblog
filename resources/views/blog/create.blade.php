...
<main>
  ...
  <section class="py-3 text-center container">
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        <h1 class="fw-light">Create a new post</h1>
  ...
  <div class="form-group">
    ...
    <textarea  name="desc" class="form-control" id="desc" rows="5" class="form-control" placeholder="Text"></textarea>
  </div>
  <div class="m-3"><button type="submit" class="btn btn-primary">Upload</button></div>
